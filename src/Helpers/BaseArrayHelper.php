...
use ZnCore\Arr\Libs\ArrayValues\ReplaceArrayValue;
use ZnCore\Arr\Libs\ArrayValues\UnsetArrayValue;
...
abstract class BaseArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = \ZnCore\Arr\Helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \ZnCore\Arr\Helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \ZnCore\Arr\Helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \ZnCore\Arr\Helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \ZnCore\Arr\Helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \ZnCore\Arr\Helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * $removed = \ZnCore\Arr\Helpers\ArrayHelper::removeValue($array, 'Jackson');
     * // result:
     ...
     * ];
     *
     * $result = \ZnCore\Arr\Helpers\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = \ZnCore\Arr\Helpers\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = \ZnCore\Arr\Helpers\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
